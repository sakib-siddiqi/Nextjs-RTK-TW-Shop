...
const Banner = () => {
  return (
    <section className="bg-indigo-100 pt-16">
      <div className="container py-10 md:py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
        <div className="lg:col-span-2 order-2 md:order-1">
          <h1 className="text-7xl text-indigo-900  font-cinzel font-bold tracking-wider mb-5">
            Winter Offer.
          </h1>
          <p className="text-indigo-900 text-lg max-w-md tracking-wide font-normal mb-5">
          ...
          <div className="flex gap-4">
            <Link href={"/shop"} className="btn btn-primary shadow-xl shadow-indigo-600/30 hover:shadow-indigo-700/40">
