    ...
    <section className="md:pt-5">
      <div className="container  grid grid-cols-8 items-end bg-gradient-to-r from-pink-100 via-indigo-50 to-purple-200 rounded-md shadow-md shadow-indigo-300/20 pt-6 md:pt-0">
        <Image
          src={boy}
          alt=""
          className="w-full col-span-4 md:col-span-2 order-2 md:order-1"
        />
        <div className="text-center col-span-8 md:col-span-4 h-full flex flex-col gap-2 justify-center items-center  order-1 md:order-2">
          <h1 className="text-4xl md:text-7xl text-indigo-600 font-semibold">
            40% Off on
          </h1>
          <h2 className="text-lg md:text-2xl text-purple-800 font-semibold mb-3">
            Selected Headphone
          </h2>
        ...
        <Image
          src={girl}
          alt=""
          className="w-full col-span-4 md:col-span-2  order-3"
        />
      </div>
    </section>
  );
